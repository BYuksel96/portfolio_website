...
- EPIC-17 Responsive AirDrop: In review, not committed. AirDrop compacts on tablet-style layouts and becomes a mobile-only top-right notification aligned near the creator handle, with a three-layer pulsing blue indicator and expansion into a correctly sized card with a yellow minimise button.
